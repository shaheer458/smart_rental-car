  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="space-y-4">
        ...
        <p><strong>Rental Start Date:</strong> {startDate}</p>
        <p><strong>Rental End Date:</strong> {endDate}</p>

        {/* Order Status Section */}
        <div className="mt-4">
          <h3 className="text-lg font-semibold">Order Status:</h3>
          <p className={`text-xl font-bold ${orderStatus === 'delivered' ? 'text-green-600' : orderStatus === 'in-transit' ? 'text-blue-600' : 'text-yellow-600'}`}>
            {getStatusText()}
          </p>
        </div>
        ...
        {orderStatus === 'in-transit' && (
          <div className="mt-6">
            ...
            <div className="space-y-2">
              <p><strong>Car's Current Location:</strong> {carLocation.latitude}, {carLocation.longitude}</p>
              <p><strong>Your Location:</strong> {userLocation.latitude}, {userLocation.longitude}</p>
              ...
              <div className="bg-gray-300 h-64 rounded-lg">
                ...
                <p className="text-center mt-28 text-gray-600">Map (Car's Location)</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div>
          {carDetails && carDetails.map((car: any, index: number) => (
